...
all: histogram_test histogram_test2 histogram_test_nocuda
...
clean:
	rm target/c/histogram_test.o target/c/histogram_test target/c/histogram_test2.o target/c/histogram_test2 target/c/histogram_test_nocuda.o target/c/histogram_test_nocuda
